...
create_table_preoptions_td_item ://11111111111111
...
dtype_len :   //1111111111111          // Data type length or size specification
...
class_block:
     T_CLASS x T_OPEN_B ( p T_COMMA?)+  | create_function*  T_CLOSE_B  T_SEMICOLON
     ;

create_function:
dtype x T_OPEN_P (func_p )* T_CLOSE_P T_OPEN_B  ( (p  T_COMMA?)*   create_function* create_new_table* new_select* new_for*  )  (T_RETURN ident)? T_CLOSE_B
;
new_type:

 x T_OPEN_B ( (p  T_COMMA)*   create_function* create_new_table* new_select* new_for*  )  T_CLOSE_B T_SEMICOLON
...
new_for:
T_FOR T_OPEN_P p T_EQUAL L_INT  T_SEMICOLON ident (T_LESS |T_GREATER) ((ident T_DOT ident)|L_INT) T_SEMICOLON ident T_ADD T_ADD T_CLOSE_P T_OPEN_B ((new_equal_to_var | (p  T_COMMA?))*   create_new_table* new_select* new_for*  ) T_CLOSE_B
;



def_if:
T_IF T_OPEN_P ((expr def_operation expr (T_AND_AND|T_PIPE)?))+ T_CLOSE_P  T_OPEN_B  ((new_equal_to_var | (p  T_COMMA?))*   create_new_table* new_select* new_for*  ) T_CLOSE_B def_else_if* def_else?;

def_else_if:
T_ELSE def_if ;

def_else:
T_ELSE T_OPEN_B block T_CLOSE_B;
...
new_equal_to_var:
p T_EQUAL ident arch
;
arch:
T_OPEN_P ident T_CLOSE_P
;
new_select :
 p T_EQUAL T_SELECT (T_COUNT (T_OPEN_P T_MUL T_CLOSE_P |(ident T_COMMA?))+ )? (ident T_COMMA?)? ( T_SUM T_OPEN_P ident T_CLOSE_P ident)? T_FROM table_name  (T_INNER T_JOIN table_name T_ON table_name T_DOT ident T_EQUAL table_name T_DOT ident )? (T_WHERE ident (T_IS | T_LESS |T_GREATER | T_EQUAL ) ident)? (T_GROUP T_BY ident)?
;
...
if_stmt :               // IF statement //1111111111111111111111111111111111
...
if_plsql_stmt : //111111111111111111111111111111111
...
if_tsql_stmt : //111111111111111111111111111111111
...
if_bteq_stmt : //11111111111111111111111111111111111
...
create_index_stmt :  //11111111111111   // CREATE INDEX statement
...
for_cursor_stmt :  //1111111111     // FOR (cursor) statement
...
for_range_stmt :   //1111111111111     // FOR (Integer range) statement
...
order_by_clause ://111111111111111111
...
bool_expr :                               // Boolean condition//11111111111111111111111111111111111111
...
bool_expr_atom ://111111111111111111111
...
bool_expr_unary ://1111111111111111111
...
bool_expr_single_in ://111111111111
...
bool_expr_multi_in :///11111111111111
...
bool_expr_binary ://1111111111111
...
bool_expr_logical_operator ://111111111111111111111111111111
...
bool_expr_binary_operator ://1111111111111
...
expr_interval ://11111111111111

       T_INTERVAL expr interval_item  

     ;

interval_item ://111111111111
...
expr_concat_item : //11111111111

       T_OPEN_P expr T_CLOSE_P 

     | expr_case//1111111111
...
expr_case :  //1111111111111                  // CASE expression
...
expr_case_searched :    //11111111111111111
...
expr_agg_window_func ://111111111111

       T_AVG T_OPEN_P expr_func_all_distinct? expr T_CLOSE_P expr_func_over_clause?//111111111

     | T_COUNT T_OPEN_P ((expr_func_all_distinct? expr) | '*') T_CLOSE_P expr_func_over_clause?//111111111

     | T_COUNT_BIG T_OPEN_P ((expr_func_all_distinct? expr) | '*') T_CLOSE_P expr_func_over_clause?//11111

     | T_CUME_DIST T_OPEN_P T_CLOSE_P expr_func_over_clause//11111111111

     | T_DENSE_RANK T_OPEN_P T_CLOSE_P expr_func_over_clause//11111111

     | T_FIRST_VALUE T_OPEN_P expr T_CLOSE_P expr_func_over_clause//111111111
...
expr_func_over_clause ://1111111111111
...
expr_func_partition_by_clause ://111111111111
...
expr_spec_func : //111111111111111

       T_ACTIVITY_COUNT //111111111111

     | T_CAST T_OPEN_P expr T_AS  dtype dtype_len? T_CLOSE_P

     | T_COUNT T_OPEN_P (expr | '*') T_CLOSE_P

     | T_CURRENT_DATE | T_CURRENT T_DATE//111111111111111111111111111111111111111111111111111111111111111111111111
...
date_literal :       ///1111111111111                      // DATE 'YYYY-MM-DD' literal
...
timestamp_literal :     //111111111111111                  // TIMESTAMP 'YYYY-MM-DD HH:MI:SS.FFF' literal
...
string :       //11111111                            // String literal (single or double quoted)
...
int_number :                               // Integer (positive or negative)//11111111111111111
...
dec_number :        //111111111111111                       // Decimal number (positive or negative)
...
bool_literal :                            // Boolean literal//111111111111
...
null_const :                              // NULL constant//11111111111111111111111
...
non_reserved_words :                      // Tokens that are not reserved words and can be used as identifiers
     ...
     | T_ALL //11111111111111

     | T_ALLOCATE

     | T_ALTER

     | T_AND//11111111111111111111111111
     ...
     | T_BEGIN   //11111111111111

     | T_BETWEEN//11111111111111111111

     | T_BIGINT  //111111111111

     | T_BINARY_DOUBLE//111111111

     | T_BINARY_FLOAT//111111111
     ...
     | T_CASE   //1111111111111

     | T_CASESPECIFIC

     | T_CAST//111111111

     | T_CHAR  //1111111111111
     ...
     | T_COUNT   //1111111111111111

     | T_COUNT_BIG   //11111111111

     | T_CREATE//1111111111111
     ...
     | T_CUME_DIST//11111111111

     | T_CURRENT //1111111111

     | T_CURRENT_DATE//111111111
     ...
     | T_DATETIME  //11111111111

     | T_DAY//11111111111111

     | T_DAYS//11111111111

     | T_DEC      //1111111111

     | T_DECIMAL  //11111111111
     ...
     | T_DENSE_RANK//1111111111111111

     | T_DESC   //1111111111111111
     ...
     | T_DISTINCT //1111111111111

     | T_DISTRIBUTE

     | T_DO        

     | T_DOUBLE     //11111111111111111
     ...
     | T_EXISTS//1111111111111111111

     | T_EXIT 

     | T_FALLBACK     //1111111111111
     ...
     | T_FIRST_VALUE    //1111111111111111
     ...
     | T_IF    //1111111111111111111111111111111111111111111
     ...
     | T_INT8//1111111111111

     | T_INTEGER   //11111111111111

     | T_INTERSECT  

     | T_INTERVAL     //11111111111111
     ...
     | T_IS    //1111111111111111111111111111111
     ...
     | T_MICROSECOND//11111111111111111

     | T_MICROSECONDS//11111111111111111
     ...
     | T_NOT       //1111111111111111111111111111

     | T_NOTFOUND     

     // T_NULL reserved word       

     | T_NUMERIC//1111111111111
     ...
     | T_OR           //`1111111111111111111111111

     | T_ORDER   //11111111111111

     | T_OUT     

     | T_OUTER

     | T_OVER//1111111111111
     ...
     | T_PARTITION  //111111111111111

     | T_PCTFREE

     | T_PCTUSED  

     | T_PRECISION     //111111111111
     ...
     | T_REAL//111111111111111

     | T_REFERENCES     

     | T_REGEXP//111111111111111
     ...
     | T_RESULT_SET_LOCATOR//111111111111

     | T_RETURN       

     | T_RETURNS

     | T_REVERSE    //1111111111

     | T_RIGHT

     | T_RLIKE//11111111111111
     ...
     | T_ROW_NUMBER//111111111111

     | T_SCHEMA

     | T_SECOND//111111111111111

     | T_SECONDS//11111111111111
     ...
     | T_SIMPLE_DOUBLE//1111111111111

     | T_SIMPLE_FLOAT//111111111

     | T_SMALLDATETIME//11111111

     | T_SMALLINT     //1111111111
     ...
     | T_SYS_REFCURSOR     //111111111

     | T_TABLE//111111111111
     ...
     | T_VARYING//111111111111111111

     | T_VARIANCE//111111111111
...
T_ALL             : A L L ;//111111111111

T_ALLOCATE        : A L L O C A T E ;

T_ALTER           : A L T E R ;

T_AND             : A N D ;//111111111111111111111111111

T_ANSI_NULLS      : A N S I '_' N U L L S ;

T_ANSI_PADDING    : A N S I '_' P A D D I N G ;

T_AS              : A S ;//11111111111

T_ASC             : A S C ;//111111111111111
...
T_AVG             : A V G ; //11111111111111

T_BATCHSIZE       : B A T C H S I Z E ;

T_BEGIN           : B E G I N ;//111111111111

T_BETWEEN         : B E T W E E N ; //1111111111111111111111111

T_BIGINT          : B I G I N T ;//1111111111

T_BINARY_DOUBLE   : B I N A R Y '_' D O U B L E ;//11111111

T_BINARY_FLOAT    : B I N A R Y '_' F L O A T ;//111111111111

T_BINARY_INTEGER  : B I N A R Y '_' I N T E G E R ;//11111111111111

T_BIT             : B I T ;//11111111111
...
T_CASE            : C A S E ;//1111111111111

T_CASESPECIFIC    : C A S E S P E C I F I C ; 

T_CAST            : C A S T ;//111111111111

T_CHAR            : C H A R ;//111111111
...
T_COUNT           : C O U N T ;//111111111111

T_COUNT_BIG       : C O U N T '_' B I G;//11111111111111

T_CREATE          : C R E A T E ;//111111111111
...
T_CURRENT         : C U R R E N T ;//11111111111
...
T_DATE            : D A T E ;//111111111

T_DATETIME        : D A T E T I M E ; //111111111111

T_DAY             : D A Y ;//111111111111

T_DAYS            : D A Y S ;//1111111111

T_DEC             : D E C ;//111111111111

T_DECIMAL         : D E C I M A L ;//1111111111111
...
T_DISTINCT        : D I S T I N C T ;//11111111111111

T_DISTRIBUTE      : D I S T R I B U T E ;

T_DO              : D O ;

T_DOUBLE          : D O U B L E ;//111111111

T_DROP            : D R O P ;

T_DYNAMIC         : D Y N A M I C ; 

T_ELSE            : E L S E ;//1111111111111
...
T_EXISTS          : E X I S T S ; //11111111111111111111111111111

T_EXIT            : E X I T ;

T_FALLBACK        : F A L L B A C K ;//111111111111
...
T_FLOAT           : F L O A T ;//111111111

T_FOR             : F O R ;//111111111
...
T_IF              : I F ;  //111111111111111111111111111111111111111111111111

T_IGNORE          : I G N O R E ; 

T_IMMEDIATE       : I M M E D I A T E ;

T_IN              : I N ;//111111111111111111

T_INCLUDE         : I N C L U D E ;

T_INDEX           : I N D E X ;//1111111111111111
...
T_INT             : I N T ;//1111111111

T_INT2            : I N T '2';//111111111111

T_INT4            : I N T '4';//1111111111

T_INT8            : I N T '8';//11111111111111

T_INTEGER         : I N T E G E R ;//11111111111

T_INTERSECT       : I N T E R S E C T ;

T_INTERVAL        : I N T E R V A L ; //11111111111111

T_INTO            : I N T O ;

T_INVOKER         : I N V O K E R ;

T_IS              : I S ;//1111111111111111111111111
...
T_LOG             : L O G ; //11111111

T_LOGGED          : L O G G E D ; 

T_LOGGING         : L O G G I N G ; 

T_LOOP            : L O O P ;//11111111111

T_MAP             : M A P ; 

T_MATCHED         : M A T C H E D ; 

T_MAX             : M A X ;//1111111111111
...
T_MICROSECOND     : M I C R O S E C O N D ;//11111111111

T_MICROSECONDS    : M I C R O S E C O N D S;//1111111111111

T_MIN             : M I N ;//111111111111

T_MULTISET        : M U L T I S E T ; 

T_NCHAR           : N C H A R ; //1111111111

T_NEW             : N E W ;

T_NVARCHAR        : N V A R C H A R ; //1111111111
...
T_NOT             : N O T ;//11111111111111111111111111111111111

T_NOTFOUND        : N O T F O U N D ; 

T_NULL            : N U L L ;//111111111111111111111111

T_NUMERIC         : N U M E R I C ; //1111111

T_NUMBER          : N U M B E R ;//11111111111
...
T_OR              : O R ; //11111111111111111111111111111

T_ORDER           : O R D E R;//111111111111

T_OUT             : O U T ;

T_OUTER           : O U T E R ;

T_OVER            : O V E R ;//11111111111
...
T_PARTITION       : P A R T I T I O N ; //1111111111111

T_PCTFREE         : P C T F R E E ; 

T_PCTUSED         : P C T U S E D ;

T_PLS_INTEGER     : P L S '_' I N T E G E R ;//111111111111

T_PRECISION       : P R E C I S I O N ; //11111111111
...
T_RESULT_SET_LOCATOR : R E S U L T '_' S E T '_' L O C A T O R ;//1111111111

T_RETURN          : R E T U R N ;

T_RETURNS         : R E T U R N S ;

T_REVERSE         : R E V E R S E ;//11111111111

T_RIGHT           : R I G H T ;

T_RLIKE           : R L I K E ;//111111111111111111
...
T_SECOND          : S E C O N D ;//11111111111111

T_SECONDS         : S E C O N D S;//111111111111111
...
T_SIMPLE_DOUBLE   : S I M P L E '_' D O U B L E ;//1111111

T_SIMPLE_FLOAT    : S I M P L E '_' F L O A T ;//1111111111

T_SIMPLE_INTEGER  : S I M P L E '_' I N T E G E R ;//1111111111111111

T_SMALLDATETIME   : S M A L L D A T E T I M E ;//11111111111111

T_SMALLINT        : S M A L L I N T ;//11111111111
...
T_STEP            : S T E P ; //1111111111111

T_STORAGE         : S T O R A G E ; 

T_STORED          : S T O R E D ;

T_STRING          : S T R I N G ;//11111111111

T_SUBDIR          : S U B D I R ; 

T_SUBSTRING       : S U B S T R I N G ; 

T_SUM             : S U M ;//1111111111111

T_SUMMARY         : S U M M A R Y ;

T_SYS_REFCURSOR   : S Y S '_' R E F C U R S O R ; //11111111111

T_TABLE           : T A B L E ;//111111111111111
...
T_THEN            : T H E N ;//111111111111

T_TIMESTAMP       : T I M E S T A M P ;//1111111111111

T_TINYINT         : T I N Y I N T ;//11111111111
...
T_UNIQUE          : U N I Q U E ;//111111111
...
T_VAR             : V A R ;//11111111111

T_VARCHAR         : V A R C H A R ;//11111111

T_VARCHAR2        : V A R C H A R '2' ;//1111111111

T_VARYING         : V A R Y I N G ;//1111111111

T_VOLATILE        : V O L A T I L E ;

T_WHEN            : W H E N ;//111111111111
...
T_ACTIVITY_COUNT       : A C T I V I T Y '_' C O U N T ;//1111111111

T_CUME_DIST            : C U M E '_' D I S T ; //1111111111111111

T_CURRENT_DATE         : C U R R E N T '_' D A T E ;//11111111

T_CURRENT_TIMESTAMP    : C U R R E N T '_' T I M E S T A M P ;

T_CURRENT_USER         : C U R R E N T '_' U S E R ;

T_DENSE_RANK           : D E N S E '_' R A N K ;//1111111111

T_FIRST_VALUE          : F I R S T '_' V A L U E; //111111111

T_LAG                  : L A G ;//11111111111111

T_LAST_VALUE           : L A S T '_' V A L U E; //111111111

T_LEAD                 : L E A D ; //1111111111
...
T_RANK                 : R A N K ;//1111111111111111

T_ROW_NUMBER           : R O W '_' N U M B E R;//111111111

T_STDEV                : S T D E V ;//1111111111

T_SYSDATE              : S Y S D A T E ;

T_VARIANCE             : V A R I A N C E ; //1111111111111
...
T_EQUAL        : '=' ;//1111111111111111

T_EQUAL2       : '==' ;//1111111111111

T_NOTEQUAL     : '<>' ;//11111111111

T_NOTEQUAL2    : '!=' ;//11111111

T_GREATER      : '>' ;//111111111111111111

T_GREATEREQUAL : '>=' ;//11111111111

T_LESS         : '<' ;//11111111111

T_LESSEQUAL    : '<=' ;//1111111111111

T_MUL          : '*' ;//111111111

T_OPEN_B       : '{' ;

T_OPEN_P       : '(' ;//111111111111111111111111111111111

T_OPEN_SB      : '[' ;

T_CLOSE_B      : '}' ; 

T_CLOSE_P      : ')' ;//11111111111111111111111111111111111
...
L_S_STRING  : '\'' (('\'' '\'') | ('\\' '\'') | ~('\''))* '\''    //1111111111     // Single quoted string literal

            ;

L_D_STRING  : '"' (L_STR_ESC_D | .)*? '"'                     //11111111111111         // Double quoted string literal

            ;

L_INT       : L_DIGIT+ ;               //111111111111                                // Integer

L_DEC       : L_DIGIT+ '.' ~'.' L_DIGIT*                               // Decimal number//11111111111111
